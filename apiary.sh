...
mkdir -p $C
cc=0
$C/$((cc++))_list_actions_for_tube_rack_resource.apib.erb << EOF 
...
$C/$((cc++))_create_a_new_empty_tube_rack.apib.erb << EOF 
...
$C/$((cc++))_create_a_new_tube_rack_and_add_it_multipe_tubes.apib.erb << EOF 
...
$C/$((cc++))_update_a_tube_rack.apib.erb << EOF
**Update a tube rack.**
...
$C/$((cc++))_physically_move_tubes_from_a_source_tube_rack.apib.erb << EOF
...
mkdir -p $C
cc=0
$C/$((cc++))_list_actions_for_spin_column_resource.apib.erb << EOF
...
$C/$((cc++))_create_a_new_empty_spin_column.apib.erb << EOF
...
$C/$((cc++))_create_a_new_empty_plate.apib.erb << EOF
...
$C/$((cc++))_create_a_new_plate_with_samples.apib.erb << EOF
...
$C/$((cc++))_update_a_plate.apib.erb << EOF
**Update a plate.**
...
$C/$((cc++))_transfer_content_from_a_source_plate_to_a_target_plate.apib.erb << EOF
...
$C/$((cc++))_list_actions_for_gel_resource.apib.erb << EOF
...
$C/$((cc++))_create_a_new_empty_gel_plate.apib.erb << EOF
...
$C/$((cc++))_create_a_new_gel_plate.apib.erb << EOF
...
$C/$((cc++))_list_actions_for_order_resource.apib.erb << EOF
...
$C/$((cc++))_create_a_new_order.apib.erb << EOF
**Create a new order.**
...
$C/$((cc++))_update_an_order.apib.erb << EOF
**Update an order.**
...
$C/$((cc++))_assign_an_item_to_a_batch.apib.erb << EOF
...
$C/$((cc++))_create_a_new_batch.apib.erb << EOF
**Create a new batch**
...
$C/$((cc++))_search_for_a_resource.apib.erb << EOF
...
$C/$((cc++))_search_for_an_order.apib.erb << EOF
**Search for an order**
...
$C/$((cc++))_search_for_a_resource_by_label.apib.erb << EOF
...
$C/$((cc++))_search_for_a_resource_by_order.apib.erb << EOF
...
$C/$((cc++))_search_for_a_resource_by_batch.apib.erb << EOF
