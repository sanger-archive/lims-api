...
migrate_test_n:
	...
	bundle exec sequel -m `bundle show lims-core`/db/migrations -e test config/database.yml
migrate_dev_n:
	...
	bundle exec sequel -m `bundle show lims-core`/db/migrations -e development config/database.yml
migrate_test:
	bundle exec sequel -m `bundle show lims-core`/db/migrations -e test config/database.yml
migrate_dev:
	bundle exec sequel -m `bundle show lims-core`/db/migrations -e development config/database.yml
