...
describe "search_for_a_labellable", :search => true do
  ...
  #     * `value`
  # 
  # Searching for a labellable is useful to get a resource knowing only its barcode for example. 
  # In fact, in a normal search, the model attribute needs to be set. In the case the model of the
  # searched resource isn't known in advance, we can search its corresponding labellable resource,
  # then get the resource (the uuid of the resource appears under the name attribute).
  # 
